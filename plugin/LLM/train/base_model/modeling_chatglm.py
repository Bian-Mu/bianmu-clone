...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel):
    def __init__(self, config: ChatGLMConfig, empty_init=True,kernel_file=""):
        super().__init__(config)
        if empty_init:
            init_method = skip_init
        else:
        ...
        if self.config.quantization_bit:
            self.quantize(self.config.quantization_bit, self.config.quantization_embeddings, use_quantization_cache=True, empty_init=True,kernel_file=kernel_file)
